...
{
 /**
  * LayoutAlgorithm v2.5.0
  *
  * Main changes:
  *  - added support for flex wrap
  */
 [CreateAssetMenu(menuName = "Flexbox/Layout Algorithms/v2.5", fileName = "Layout Algorithm v2.5.asset", order=100)]
 public class FlexboxLayoutAlgorithm250 : IFlexboxLayoutAlgorithm
 {
  public override string defaultAssetName
  {
   get { return "Layout Algorithm v2.5.0-flexwrap"; }
  }
 ...
 private int _layoutsStartedUnfinished = 0;
  public override void Layout(FlexContainer fc)
  {
   ...
   Debug.Log("Starting layout of "+fc.hierarchicalName+" using Flexbox "+defaultAssetName+" (num already running: "+_layoutsStartedUnfinished);
   ...
   if( fc.showDebugMessages )
   Debug.Log("-- finished layout of "+fc.hierarchicalName+" using Flexbox "+defaultAssetName+" (num layouts still running: "+_layoutsStartedUnfinished);
  }
